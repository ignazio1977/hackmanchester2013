...
/** @return distance between two doubles; if they have the same sign, this is their difference; if the have different signs, the difference is the sum of the absolute values.*/
